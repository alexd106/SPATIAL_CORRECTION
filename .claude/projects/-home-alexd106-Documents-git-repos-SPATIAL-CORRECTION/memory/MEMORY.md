...
## Project Overview
Field trial spatial correction framework for R. Working directory: `/home/alexd106/Documents/git_repos/SPATIAL_CORRECTION`.

## Key Files
- `scripts/SpatialCorrectionFlexible.R` — main script: per-bench + joint multi-bench functions
- `scripts/simulate_spatial_data.R` — simulation framework (spatial types 1-6, per-bench params)
...
## SpatialCorrectionFlexible.R — Architecture
